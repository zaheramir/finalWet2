...
StatusType world_cup_t::add_player(int playerId, int teamId,
    ...
    UFNode newNode(playerId, tempPlayer);
...
output_t<int> world_cup_t::play_match(int teamId1, int teamId2)
{
    ...
    UFNode* captain1 = playersTable.find(team1->key_.captain.getPlayerId());
    UFNode* captain2 = playersTable.find(team2->key_.captain.getPlayerId());
...
output_t<int> world_cup_t::num_played_games_for_player(int playerId)
{
    ...
    UFNode* playerNode = this->playersTable.find(playerId);
...
StatusType world_cup_t::buy_team(int teamId1, int teamId2) {
    ...
    else
    {
        ...
        if(firstTeam->key_.getPlayersNum() >= secondTeam->key_.getPlayersNum())
        {
            ...
            UFNode* firstCaptain = playersTable.find(firstTeam->key_.captain.getPlayerId());
            UFNode* secondCaptain = playersTable.find(secondTeam->key_.captain.getPlayerId());
